...
public class SortService {
    ...
    public List<Part> applySort(List<Part> filteredParts, String sortField) {
        ComparatorForComparableImplementors comparator;
        if (lastSortField.equals(sortField)) {
            if (lastSortAscending) {
                lastSortAscending = false;
                comparator = new ComparatorForComparableImplementors(sortField, false);
            } else {
    ...
    private class ComparatorForComparableImplementors implements Comparator<Part> {
        private String sortedField;
        private Boolean ascending;

        public ComparatorForComparableImplementors(String sortedField, Boolean ascending) {
